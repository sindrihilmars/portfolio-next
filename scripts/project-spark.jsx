...
const SPARK_SECTIONS = [
  {
    ...
    "heading": "A program in decline.",
    "paragraphs": [
      "The car did not disappear because one person left. That would be too neat, and it would not be true. Covid played a role. Graduation played a role. The limited depth of the school and the alumni base played a role. There are probably parts of the story I still do not know, because I was not there when the first cracks opened. What I can describe is the programme I walked into: a team with ambition and capable people, but no one inside the active membership who had been part of building a functional car.",
      "That changes the work completely. You are not improving a known system. You are inheriting a half-finished one, with several years of decisions embedded in PCBs, cables, brackets, spreadsheets, and assumptions nobody can fully explain. The car had become something each generation tried to finish without quite knowing what finished was supposed to look like. Every semester added more effort and, often, more uncertainty.",
      "The electrical system showed this most clearly. When I joined, there were about six months until the head of electrical quit. He was replaced, and about a year later that lead quit as well. Neither of those departures happened in a vacuum. The electric lead was being asked to debug the most complex system in the car, a system made from self-made PCBs and cables that had accumulated errors on all sides for years. At some point, debugging stops being a clean engineering problem and becomes archaeology.",
      "The battery pack was buried inside that workload. It should have been separated from the rest of the electrical system and owned as its own programme-level risk. Instead, it sat under an electric lead who already had more than enough to untangle. No one with the necessary experience and bird's-eye view stepped in early enough to say: this has to be decoupled, or the person responsible for the electrical system has no fighting chance. I do not think anyone could articulate that clearly at the time. We were too close to the mess.",
      "Team Spark had never really produced a good battery pack. In previous years, the mechanical attachment of the batteries to the car was more of a suggestion than a necessity. There is a story from around 2018 where the car simply was not allowed to crash because the batteries were not properly constrained inside it. When the rules eventually required teams to prove the battery pack could withstand 20g of acceleration in the vertical direction without damage, the whole design philosophy collapsed. The pack should have become a top priority. Instead, it remained one more thing on the list.",
      "That kind of environment is hard to recruit into, and harder to stay in. If the car has not driven for years, and nobody can guarantee even a driveable car by the end of the semester, investing your time becomes difficult to justify. Some people respond by contributing a moderate amount and protecting the rest of their life. Others jump in, give it everything, and burn out when the work is not rewarded by visible progress.",
      "The people who approached it more moderately often did better. That says something uncomfortable about the state of the programme. It was not that the most committed people lacked ability. It was that the programme, as it existed then, could absorb huge amounts of effort without converting that effort into a running car. A healthy team can reward obsession. An unhealthy one can punish it.",
      "So when I talk about Team Spark losing the thread, I do not mean that the team lacked ambition. The ambition was obvious. What it lacked was depth, continuity, and a structure that could protect the important work from being buried under everything else. The battery pack is the cleanest example, so I am going to keep coming back to it. It carried the larger organisational problem in one subsystem."
    ]
  },
  {
    "num": "02",
    "label": "Joining the team",
    "heading": "Croatia, overhead, and the next group of people.",
    "paragraphs": [
      "I joined Team Spark in the fall of 2023 and was placed in the drivetrain group. The big project that year was the monocoque — the carbon fibre chassis. It was not an easy project. There were weeks of learning how the process worked, making mistakes, preparing materials, and putting in the labour. We baked the body in Össur's facilities, and that is where I met Mási. He worked at the company and really saved our asses during the process, mostly in his own time. By the end, he was just happy to hear that next semester he had a place in our team. He is now our head of chassis.",
      "The monocoque is a good example of what was still alive in the team. Even in a programme that had not produced a driveable car for years, people were willing to take on difficult work. But the car itself was only part of what Team Spark demanded from them.",
      "During the school year, Team Spark is a course within the University of Iceland, but it is almost completely run by the individuals inside the team. There is a weekly team meeting, weekly group sessions, sometimes two in a week, and group lead meetings. The team also runs its own internal courses: 3D modelling, PCB design, welding, and a mandatory safety course for working on the car. When new students come in, the team receives them. When the team competes, the team members organise transport for the car, the campsite, the paperwork, and the logistics of moving an Icelandic Formula Student team into mainland Europe.",
      "On top of that, the stationary car became one of the programme's main contributions to the school. We took it to Vísindavaka Rannís, Legókeppnin, UTmessan, Háskóladagurinn, Dagur Verkfræðinnar, and Verk og vit. Those events usually meant taking a weekend to transport the car, set it up, stand beside it, and explain the project. We also received visiting student groups, organised company visits, recruitment events, a design push getaway, Christmas movie nights, Þrettándi, and the annual árshátíð. We handled sponsor communication. We administered the Formula Student submission process, including the full day of quizzes, documents, and bookkeeping required to get into a competition.",
      "All of this was real work, and much of it was valuable. It also meant that ambitious people who joined because they wanted to build a race car were quickly pulled into everything around the race car. If you came in with a burning interest in suspension, there was a good chance you would end up spending a weekend at a public event, preparing a safety course, or helping with competition paperwork. In a functional team, that overhead is part of the bargain. In a team with a stationary car, it becomes harder to justify.",
      "Croatia in the summer of 2024 brought this into focus. The team went as a concept entry. The car did not drive, but getting it there still required the full machinery: documents, transport, shipping, camping, equipment, and people willing to spend their summer dragging a non-running car through a European competition. It was an achievement, but it also revealed the cost of keeping the programme alive while the core promise remained unmet.",
      "After Croatia, a large portion of the team left. Some graduated. Some did not continue in school. Some were simply done. A lot of the remaining people were burned out, because the benefit of pouring yourself into a team that did not drive was no longer obvious. Around January it was fairly clear to me that we had to think longer term. There was an outside chance the electrical system would suddenly click, because at the time I did not know better, but I was no longer counting on it.",
      "I also started to understand that the electrical problem was not something I could learn and fix by brute force. What we needed there was experience — preferably an electrician taking a degree in electrical engineering, someone comfortable debugging physical systems instead of just hoping the next PCB or cable would be the one that made everything work. My contribution had to be elsewhere.",
      "What I could do was prepare the ground. I could help build a group of leaders for the systems that were within our scope as a student team: drivetrain, aero, chassis, suspension. I could make sure the electrical system had more than one person around it. I could find someone willing to take personal responsibility for the battery pack. I could hold on to enough older members to cover the administrative overhead, so the group leaders could focus on their systems instead of being pulled into every public event, course, quiz, document, and logistics problem.",
      "I did not count on bringing Kristján back. What I did try to do was create a team he could step into without having to carry the entire programme on his back. If he returned, he should be able to focus on the electrical system. That still only became enough because Róbert joined later — an electrician with debugging experience — and from Christmas break onward poured his time into the electrical system. But by then the rest of the car was no longer waiting for the electrical system to become a reason to organise. Drivetrain, aero, chassis, suspension, and the battery pack all had people around them. Once the electrical system came online, the rest of the team was ready to go."
    ]
  },
  {
    "num": "03",
